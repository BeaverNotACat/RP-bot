...
class Image:
    ...
    def __init__(self):
        ...
        self.high_physical_health = Image.open('images/HP_high.png').convert("RGBA")
        self.middle_physical_health = Image.open('images/HP_mid.png').convert("RGBA")
        self.low_physical_health = Image.open('images/HP_low.png').convert("RGBA")
        self.high_mental_health = Image.open('images/SP_high.png').convert("RGBA")
        self.middle_mental_health = Image.open('images/SP_mid.png').convert("RGBA")
        self.low_mental_health = Image.open('images/SP_low.png').convert("RGBA")
    ...
    def health_condition_image(self, head_hp, body_hp, r_leg_hp, l_leg_hp, r_arm_hp, l_arm_hp, sp):
        ...
        self.body.save("images/hp_temp.png")
        return